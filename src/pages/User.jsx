...
function User() {
  ...
  useEffect(() => {
    ...
    getUserData()
  }, [dispatch, params.login]); // empty array: re-render once
            ...
            <div className="w-full rounded-lg shadow-md bg-base-100 stats mb-6">
              {location && (
                <div className="stat">
                  ...
                  <div className="text-lg stat-value text-black-400">
                    {location}
                  </div>
                </div>
              )}
            ...
            <div className="w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats">
              <div className="stat">
                <div className="stat-figure text-secondary">
                  <FaUsers color="green" className="text-3xl md: text-5xl" />
                </div>
              ...
              <div className="stat">
                <div className="stat-figure text-secondary">
                  <FaCodepen color="green" className="text-3xl md: text-5xl" />
                </div>
              ...
              <div className="stat">
                <div className="stat-figure text-secondary">
                  <FaStore color="green" className="text-3xl md: text-5xl" />
                </div>
